...
const Auth = () => {
  ...
  return <div className="min-h-screen bg-background relative flex items-center justify-center px-6">
        ...
        duration: 0.5
          ...
          <div className="bg-card border border-border rounded-2xl p-8 shadow-2xl backdrop-blur-xl">
            ...
            <div className="mt-6 text-center">
              <button onClick={() => setIsSignUp(!isSignUp)} className="text-sm text-muted-foreground hover:text-foreground transition-colors" disabled={loading}>
                {isSignUp ? <>Already have an account? <span className="text-primary font-medium">Sign In</span></> : <>Don't have an account? <span className="text-primary font-medium">Sign Up</span></>}
              </button>
            </div>
          </div>
        </motion.div>
